...
if ($result->num_rows == 1) {
	...
	if ($pwd === $plainTextPasswordFromDB) {
        ...
        header("Location: http://localhost:8888/final_project/subscription.html");
        exit;
  ...
  <div>
	...
	<div id="s1">
      ...
      <table class="subscription-table">
        ...
        <tr>
          <td>Standard</td>
          <td>Enhanced features, priority support</td>
          <td>$19.99/month</td>
        </tr>
        <tr>
          <td>Premium</td>
          <td>Full access, premium support</td>
          <td>$29.99/month</td>
        </tr>
      </table>
	  ...
	  <div id="p1">
		  ...
		  <p>For inquiries:</p>
		  <p>Phone: 718-456-7890</p>
		  <p>Email: hobbyEN@hobbyist.com</p>
